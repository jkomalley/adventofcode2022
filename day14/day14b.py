...
def print_wall(wall, y_range = [i for i in range(0, 15, 1)],\
...
def sand_fall(wall):
    ...
    while True:
        cur_sand = sand_start[::]
        if wall[cur_sand[0]][cur_sand[1]] == 'o':
...
def main():
    ...
    for _ in range(500):
        wall.append(['.' for _ in range(1000)])
    ...
    rocks.append([[0,highest_y],[999,highest_y]])
